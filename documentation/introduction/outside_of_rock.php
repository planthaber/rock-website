<div class="container">
    <ul class="breadcrumb">
        ...
        <li class="active">Using Rock packages outside of Rock</li>
    </ul>
    ...
    <div class="row margin-bottom-40">
        ...
        <div class="col-md-9 col-sm-9">
            ...
            <h1 class="active">Using Rock packages outside of Rock</h1>
...
make install
                    ...
                    <p class="note note-success">The previous step will install everything but the Spline classes, which are
